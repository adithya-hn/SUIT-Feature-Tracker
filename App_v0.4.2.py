...
class Window_(QDialog):
    ...
    def plot(self):
        ...
        pathlib.Path((Current_dir+'/'+'Downloaded_data')).mkdir(parents=True, exist_ok=True) 
        Fname='AIA'+yr+mt+day+'_'+hr+even_min+'00'+'_'+channel+'.fits'
        existing_fl=Current_dir+'/'+'Downloaded_data'+'/'+Fname
        print(existing_fl)
        Down_dir=Current_dir+'/'+'Downloaded_data'
        
        if os.path.exists(existing_fl):
            print('File already exists bro....')
        else:
            try:
                print(aia_fname)
...
class Ui_MainWindow(object):
    ...
    def Update_vals(self):
        ...
        print('Updated',sky.Tx.arcsec,sky.Ty.arcsec)
    ...
    def open_About(self):
        # Define the URL of the website
        website_url = 'https://github.com/adithya-hn/SUIT-AR-Tracker'
        QDesktopServices.openUrl(QUrl(website_url))
    
    def open_Updates(self):
        # Define the URL of the website
        website_url = 'https://github.com/adithya-hn/SUIT-AR-Tracker/tree/main'
        QDesktopServices.openUrl(QUrl(website_url))
    ...
    def setupUi(self, MainWindow):
        ...
        self.Date_input_1.setDateTime(QtCore.QDateTime.currentDateTime())
    ...
    def Light_theme(self):
        ...
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        brush = QtGui.QBrush(QtGui.QColor(239, 239, 239))
        #self.X2_output.setPalette(palette)
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Window, brush)
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.version_Label.setText(_translate("MainWindow", "Version :0.4.2"))
        ...
        self.actionContact.setText(_translate("MainWindow", "Documentation"))
...
if __name__ == "__main__":
    ...
    app.setWindowIcon(QIcon('App_logo.svg'))
